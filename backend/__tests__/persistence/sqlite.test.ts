...
describe('SQLite persistence', () => {
  ...
  describe('init()', () => {
    it('should create the directory if it does not exist', async (): Promise<void> => {
    ...
    it('should log when NODE_ENV is not test', async (): Promise<void> => {
  ...
  describe('getItems()', () => {
    it('should return an empty array when no items exist for the user', async (): Promise<void> => {
        const items = await db.getItems(USER_ID);
        expect(items).toEqual([]);
    });

    it('should return only items belonging to the user', async (): Promise<void> => {
    ...
    it('should return all stored items for the user', async (): Promise<void> => {
        await db.storeItem(sampleItem);
        await db.storeItem({
            id: 'test-uuid-2',
            name: 'Second todo',
  ...
  describe('getItem()', () => {
    ...
    it('should return undefined if item belongs to another user', async (): Promise<void> => {
        await db.storeItem(sampleItem);
  ...
  describe('storeItem()', () => {
    it('should store a new item and retrieve it', async (): Promise<void> => {
        await db.storeItem(sampleItem);
    ...
    it('should correctly store completed=true as boolean', async (): Promise<void> => {
    ...
    it('should correctly store completed=false as boolean', async (): Promise<void> => {
        await db.storeItem(sampleItem);
  ...
  describe('updateItem()', () => {
    it('should update the name of an existing item', async (): Promise<void> => {
        await db.storeItem(sampleItem);
    ...
    it('should update the completed status of an existing item', async (): Promise<void> => {
        await db.storeItem(sampleItem);
    ...
    it('should not update item belonging to another user', async (): Promise<void> => {
        await db.storeItem(sampleItem);
  ...
  describe('removeItem()', () => {
    it('should delete an existing item and return true', async (): Promise<void> => {
        await db.storeItem(sampleItem);
    ...
    it('should return false when trying to delete a non-existent item', async (): Promise<void> => {
        const result = await db.removeItem('nonexistent-id', USER_ID);
        expect(result).toBe(false);
    });

    it("should return false when trying to delete another user's item", async (): Promise<void> => {
        await db.storeItem(sampleItem);
  ...
  describe('User methods', () => {
    describe('createUser()', () => {
      it('should create a user and retrieve by email', async (): Promise<void> => {
      ...
      it('should throw on duplicate email', async (): Promise<void> => {
          await db.createUser(sampleUser);
    ...
    describe('findUserById()', () => {
      ...
      it('should return undefined for non-existent id', async (): Promise<void> => {
    ...
    describe('deleteUser()', () => {
      it('should delete user and cascade todos', async (): Promise<void> => {
          await db.createUser(sampleUser);
          await db.storeItem(sampleItem);
    ...
    describe('getAllUserData()', () => {
      ...
      it('should throw if user does not exist', async (): Promise<void> => {
